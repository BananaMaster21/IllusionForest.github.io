...
function obstacleFloor (image, x, y, width, height) {
   ...
   if (y <= caracterY && caracterX + caracterW /2 > x && caracterX + caracterW /2 < x + width) {fallStop = 1; onPlatform = 1; onGround = 1;}else {fallStop = 0; onPlatform = 0; if (caracterY < ground - caracterH && jump === 0) {onGround = 0;}}
}
