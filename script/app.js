...
function game () { 
    ...
    if (playLevel === 7) { 
        ...
        }else if(instructionTimer < 225){ctx1.drawImage(box, canvasesW - caracterW *6.5 - caracterW *1.5, floor - caracterH *2.5 - caracterH *0.75, caracterW *2.5, caracterH *1.5);ctx1.fillText("To pass", canvasesW - caracterW *4.5 - caracterW *0.75, floor - caracterH *2.5 - caracterH *0.3);ctx1.fillText("Answer this riddle you must", canvasesW - caracterW *4.5 - caracterW *0.75, floor - caracterH *1.75 - caracterH *0.3);}
        } 
