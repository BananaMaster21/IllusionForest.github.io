...
function check (n){if(n===1){if(first===1&&crystalActivated1===1||first===2&&crystalActivated2===1||first===3&&crystalActivated3===1||first===4&&crystalActivated4===1||first===5&&crystalActivated5===1){ctx1.drawImage(shape2,caracterW*1.375,canvasesH*0.75-caracterH*0.1,caracterW*1.54,caracterH*1.2);}}}
