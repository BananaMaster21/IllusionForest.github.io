...
function crystal (what, thing, x, y)  { if(thing === 0){ctx1.drawImage(what, x, y, caracterW *0.5, caracterH *0.75);} if (caracterX + caracterW /2 > x && caracterX + caracterW /2 < x + caracterW *0.5 && caracterY - caracterH /3 >= y && caracterY - caracterH /3 <= y + caracterH *0.75 ) { if (what === crystal1) {hasCrystal1 = 1;sort(1);} if (what === crystal2) {if(hasCrystal2 === 0){if(setDifficulty.diff === 0){lives = 3;}else if(setDifficulty.diff === 1){lives = 2;}}hasCrystal2 = 1;crystalActivated2 = 1;sort(2);} if (what === crystal3) {hasCrystal3 = 1;sort(3);} if (what === crystal4) {hasCrystal4 = 1;sort(4);} if (what === crystal5) {hasCrystal5 = 1;sort(5);}}} 
function showOwnedCrystals (){if(first === 1){if(crystalActivated1===1){ctx1.drawImage(shape2,caracterW*1.375,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal1,caracterW*1.5, canvasesH*0.75,caracterW*0.75,caracterH);}else if(first === 2){if(crystalActivated2===1){ctx1.drawImage(shape2,caracterW*1.25,canvasesH*0.75-caracterH*0.1,caracterW*1.625,caracterH*1.2);}ctx1.drawImage(crystal2,caracterW*1.5, canvasesH*0.75,caracterW*0.75,caracterH);}else if(first === 3){if(crystalActivated3===1){ctx1.drawImage(shape2,caracterW*1.375,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal3,caracterW*1.5, canvasesH*0.75,caracterW*0.75,caracterH);}else if(first === 4){if(crystalActivated4===1){ctx1.drawImage(shape2,caracterW*1.375,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal4,caracterW*1.5, canvasesH*0.75,caracterW*0.75,caracterH);}else if(first === 5){if(crystalActivated5===1){ctx1.drawImage(shape2,caracterW*1.375,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal5,caracterW*1.5, canvasesH*0.75,caracterW*0.75,caracterH);}else if(second === 1){if(crystalActivated1===1){ctx1.drawImage(shape2,caracterW*3.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal1,caracterW*3.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(second === 2){if(crystalActivated2===1){ctx1.drawImage(shape2,caracterW*3.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal2,caracterW*3.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(second === 3){if(crystalActivated3===1){ctx1.drawImage(shape2,caracterW*3.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal3,caracterW*3.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(second === 4){if(crystalActivated4===1){ctx1.drawImage(shape2,caracterW*3.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal4,caracterW*3.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(second === 5){if(crystalActivated5===1){ctx1.drawImage(shape2,caracterW*3.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal5,caracterW*3.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(third === 1){if(crystalActivated1===1){ctx1.drawImage(shape2,caracterW*4.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal1,caracterW*4.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(third === 2){if(crystalActivated2===1){ctx1.drawImage(shape2,caracterW*4.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal2,caracterW*4.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(third === 3){if(crystalActivated3===1){ctx1.drawImage(shape2,caracterW*4.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal3,caracterW*4.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(third === 4){if(crystalActivated4===1){ctx1.drawImage(shape2,caracterW*4.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal4,caracterW*4.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(third === 5){if(crystalActivated5===1){ctx1.drawImage(shape2,caracterW*4.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal5,caracterW*4.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fourth === 1){if(crystalActivated1===1){ctx1.drawImage(shape2,caracterW*5.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal1,caracterW*5.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fourth === 2){if(crystalActivated2===1){ctx1.drawImage(shape2,caracterW*5.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal2,caracterW*5.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fourth === 3){if(crystalActivated3===1){ctx1.drawImage(shape2,caracterW*5.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal3,caracterW*5.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fourth === 4){if(crystalActivated4===1){ctx1.drawImage(shape2,caracterW*5.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal4,caracterW*5.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fourth === 5){if(crystalActivated5===1){ctx1.drawImage(shape2,caracterW*5.125,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal5,caracterW*5.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fith === 1){if(crystalActivated1===1){ctx1.drawImage(shape2,caracterW*6.875,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal1,caracterW*7,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fith === 2){if(crystalActivated2===1){ctx1.drawImage(shape2,caracterW*6.875,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal2,caracterW*7,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fith === 3){if(crystalActivated3===1){ctx1.drawImage(shape2,caracterW*6.875,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal3,caracterW*7,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fith === 4){if(crystalActivated4===1){ctx1.drawImage(shape2,caracterW*6.875,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal4,caracterW*7,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fith === 5){if(crystalActivated5===1){ctx1.drawImage(shape2,caracterW*6.875,canvasesH*0.75-caracterH*0.1,caracterW*1.75,caracterH*1.2);}ctx1.drawImage(crystal5,caracterW*7,canvasesH*0.75,caracterW*0.75,caracterH);}}
...
var cW = caracterW; 
var cH = caracterH; 
function caracter () { if (hasCrystal4 === 1 && crystalActivated4 === 1 && crystalActivated4 === 1){cW = caracterW *0.75;cH = caracterH *0.75;}else{cW = caracterW;cH = caracterH;} ctx1.drawImage(caracterImage, caracterX, caracterY - caracterH, cW, cH); } 
