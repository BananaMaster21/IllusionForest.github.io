...
//----------------------------------------------------------
   if (playLevel === 4) {
      ...
      obstacle(rock, canbvasesW /2 - caracterW /2, floor - caracterH *1.5, caracterW, caracterH *1.5, 2);
      obstacle(rock, canvasesW /2 + caracterW *3.5, 0 - caracterH /2, caracterW, caracterH *3, 3);
