...
function game () { 
    ...
    if (playLevel === 7) { 
        ...
        }else if(instructionTimer < 806.25){ctx1.fillStyle = "rgba( 0, 0, 0,0.8)";ctx1.fillRect(0, 0, canvasesW, canvasesH);ctx1.drawImage(jelly,canvasesW/4,canvasesH/8,canvasesW/2,canvasesH*0.75);}
                                                                       } 
        //objects not in use 
