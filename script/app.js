...
function obstacleFloor (image, x, y, width, height) {
   ...
   if (y <= caracterY && caracterX + caracterW /2 > x && caracterX + caracterW /2 < x + width) {fallStop = 1; onPlatform = 1; if (jump === 0) {onGround = 1;}}else {fallStop = 0; onPlatform = 0; if (jump === 0 && caracterY < ground - caracterH) {onGround = 0;}}
}
