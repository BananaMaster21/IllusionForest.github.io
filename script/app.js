...
function game () { 
    ...
    if (playLevel === 2793487593) { 
        ...
        //bird
        if(WentHere2===0){ctx1.drawImage(bird, caracterW, floor - caracterH*2.5, caracterW*3.5, caracterH*2.5);}else if (WentHere2===1){ctx1.drawImage(nest, caracterW, floor - caracterH*1.25, caracterW*3.5, caracterH*1.25);crystal(crystal1,hasCrystal1, xx, floor - caracterH*2.25, caracterW*0.75, caracterH*0.75);}
