...
function game () { 
    ...
    if (playLevel === 7) { 
        ...
        }else if(instructionTimer < 675){ctx1.drawImage(egg,canvasesW*0.25-caracterW*1.25/2,canvasesH*5-caracterH*1.5/2,caracterW*1.25,caracterH*1.5);ctx1.drawImage(chicken,canvasesW*0.75-caracterW*1.25/2,canvasesH*5-caracterH*1.5/2,caracterW*1.25,caracterH*1.5);}
                                                                       }
