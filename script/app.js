...
requestAnimationFrame(gamePart1);
  ...
  if (playLevel === 1) {
   ...
   if (playLevel === 1) {
      ...
      obstacle(rock, canvasesW - caracterW *3, floor - caracterH *2, caracterW, caracterH *2, 3);
      obstacle(rock, canvasesW - caracterW *2, floor - caracterH *5, caracterW, caracterH *5, 4);
