...
requestAnimationFrame(gamePart1);
  ...
  if (playLevel === 3) {
   ...
   if (playLevel === 3) {
      ...
      //obstacles
      obstacle(rock, canvasesW *1/6 + caracterW *2 + caracterW *2/3, canvasesH *1/12 + caracterH *1.5 - caracterH /8, caracterW, caracterH *2/3, 2);
      obstacle(rock, canvasesW *1/6 + caracterW *1/3 + caracterW *3, floor - caracterH, caracterW, caracterH, 3);
