...
//----------------------------------------------------------
   if (playLevel === 3) {
      ...
      //traps
      movingTrap(spikeBall, canvasesW *1/6 + caracterW + caracterW *1/3 + traping.mh1, 0, canvasesH *2/6 + traping.mv1, canvasesH *2/6, caracterW, caracterW, canvasesH *1/3, "vertical", canvasesW /200, 1);
...
//----------------------------------------------------------
   if (playLevel === 4) {
      ...
      movingTrap(spikeBall, canvasesW *1/6 +  caracterW *1/3 + caracterW *7 + traping.mh2, 0, 0 + traping.mv2, canvasesH *2/6 - caracterH, caracterW, caracterW, canvasesH *3/5 - caracterW *1.5, "vertical", canvasesW /200, 2);
