...
requestAnimationFrame(gamePart1);
  ...
  if (playLevel === 3) {
   ...
   if (playLevel === 3) {
      ...
      trap(spikeWall, canvasesW *5/8 + caracterW *1.5, floor - caracterH *2.5, caracterW *3/4, caracterH *1.5);
      trap(spikeFloor, canvasesW *5/8 + caracterW *2, floor - caracterH *4 - caracterH *1/4, caracterW, caracterH *3/4);
