...
function obstacle (image, x, y, width, height, number) {
   ...
   //colision top
   if (y <= caracterY && caracterX + caracterW /2 > x && caracterX + caracterW /2 < x + width) {if (caracterY - caracterH >= y + height /2) {sliping = 1;}else {fallStop = 1; if (number === 1) {ob.fall_1 = 0;}else if (number === 2) {ob.fall_2 = 0;}else if (number === 3) {ob.fall_3 = 0;}}}else {
