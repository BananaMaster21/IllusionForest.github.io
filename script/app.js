...
//----------------------------------------------------------
   if (playLevel === 3) {
      ...
      //traps
      movingTrap(spikeBall, canvasesW *1/6 + caracterW + caracterW *1/3 + traping.mh1, canvasesW /2, canvasesH *2/6 + traping.mv1, canvasesH *2/6, caracterW, caracterW, canvasesH *1/3, "vertical", 1 + traping.start1, 1);
