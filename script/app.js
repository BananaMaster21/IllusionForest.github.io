...
function test (){if(first===2&&crystalActivated2===1){ctx1.drawImage(shape2,caracterW*1.375,canvasesH*0.75-caracterH*0.1,caracterW*1.125,caracterH*1.2);}}
...
function showOwnedCrystals (){test();if(first === 1){ctx1.drawImage(crystal1,caracterW*1.5, canvasesH*0.75,caracterW*0.75,caracterH);}else if(first === 2){ctx1.drawImage(crystal2,caracterW*1.5, canvasesH*0.75,caracterW*0.75,caracterH);}else if(first === 3){ctx1.drawImage(crystal3,caracterW*1.5, canvasesH*0.75,caracterW*0.75,caracterH);}else if(first === 4){ctx1.drawImage(crystal4,caracterW*1.5, canvasesH*0.75,caracterW*0.75,caracterH);}else if(first === 5){ctx1.drawImage(crystal5,caracterW*1.5, canvasesH*0.75,caracterW*0.75,caracterH);}else if(second === 1){ctx1.drawImage(crystal1,caracterW*3.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(second === 2){ctx1.drawImage(crystal2,caracterW*3.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(second === 3){ctx1.drawImage(crystal3,caracterW*3.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(second === 4){ctx1.drawImage(crystal4,caracterW*3.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(second === 5){ctx1.drawImage(crystal5,caracterW*3.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(third === 1){ctx1.drawImage(crystal1,caracterW*4.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(third === 2){ctx1.drawImage(crystal2,caracterW*4.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(third === 3){ctx1.drawImage(crystal3,caracterW*4.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(third === 4){ctx1.drawImage(crystal4,caracterW*4.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(third === 5){ctx1.drawImage(crystal5,caracterW*4.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fourth === 1){ctx1.drawImage(crystal1,caracterW*5.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fourth === 2){ctx1.drawImage(crystal2,caracterW*5.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fourth === 3){ctx1.drawImage(crystal3,caracterW*5.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fourth === 4){ctx1.drawImage(crystal4,caracterW*5.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fourth === 5){ctx1.drawImage(crystal5,caracterW*5.25,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fith === 1){ctx1.drawImage(crystal1,caracterW*7,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fith === 2){ctx1.drawImage(crystal2,caracterW*7,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fith === 3){ctx1.drawImage(crystal3,caracterW*7,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fith === 4){ctx1.drawImage(crystal4,caracterW*7,canvasesH*0.75,caracterW*0.75,caracterH);}else if(fith === 5){ctx1.drawImage(crystal5,caracterW*7,canvasesH*0.75,caracterW*0.75,caracterH);}}
