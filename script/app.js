...
requestAnimationFrame(gamePart1);
  ...
  if (playLevel === 2) {
   ...
   if (playLevel === 2) {
      ...
      trap(spikeFloor, canvasesW *1/4 + caracterW *3, floor - caracterH /2, caracterW, caracterH /2);
      trap(spikeFloor, canvasesW *1/4 + caracterW *4, floor - caracterH /2, caracterW *1.5, caracterH /2);
